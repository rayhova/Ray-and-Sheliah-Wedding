...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhmxk1WHZJTlTGaRd97zg0EtvgAomqOFg"></script>
<script type="text/javascript">
(function($) {
...
geocoder.geocode( { 'address': address}, function(results, status) {
  ...
  if (status == google.maps.GeocoderStatus.OK) {
    ...
    jQuery('.marker').attr('data-lat',latitude);
    jQuery('.marker').attr('data-lng',longitude);
  } 
